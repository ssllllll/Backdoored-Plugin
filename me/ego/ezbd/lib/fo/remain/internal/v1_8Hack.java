...
class v1_8Hack extends EnderDragonEntity {
    ...
    public Object getTeleportPacket(Location loc) {
        ...
        try {
            packet = PacketPlayOutEntityTeleport.getConstructor(Integer.TYPE, Integer.TYPE, Integer.TYPE, Integer.TYPE, Byte.TYPE, Byte.TYPE, Boolean.TYPE, Boolean.TYPE).newInstance(this.id, loc.getBlockX() * 32, loc.getBlockY() * 32, loc.getBlockZ() * 32, (byte)((int)loc.getYaw() * 256 / 360), (byte)((int)loc.getPitch() * 256 / 360), false, false);
    ...
    public Object getWatcher() {
        ...
        try {
            ...
            a.invoke(watcher, 5, Byte.valueOf((byte)(this.isVisible() ? 0 : 32)));
